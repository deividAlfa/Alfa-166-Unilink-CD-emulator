...
It used a STM32 "blackpill" board with STM32F411 running at 96MHz.<br>
It uses the STM32 Cube IDE. The pinouts can be seen opening the .ioc file (CubeMX configuration).<br>
