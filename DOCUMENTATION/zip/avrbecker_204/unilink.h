...
#define DISC_MSG					{C_UNILINK_MADDR, unilink_ownaddr, 0x90, 0x50, tracknbr, 0x06, 0x06, (unilink_lastdisc-0x10)*16}
...
#define MODE_MSG					{C_UNILINK_MADDR, unilink_ownaddr, 0x94,0x00,  0x00,0x80,0x00,0x00}
